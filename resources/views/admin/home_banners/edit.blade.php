...
<div class="content-wrapper">
    <div class="content-margin">
        <div class="dashboard_heading flex-css">
            <div class="name">
                <h2 class="m-0">Edit Home Banner</h2>
            </div>
        ...
        <section class="dashboard_box dashboard_padding">
            <div class="border-box profile_edit">
                <form method="POST" action="{{ route('admin.home-banners.update', $homeBanner->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-6">
                    ...
                    <div class="col-6">
                            <div class="form-group">
                                ...
                                <!-- @if($homeBanner->banner_image)
                                    <div class="mt-2">
                                        <img src="{{ asset('admin_assets/uploads/' . $homeBanner->banner_image) }}" alt="Home Banner Image" class="img-thumbnail" style="width: 100px;">
                                    </div>
                                @endif -->
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('banner_title') is-invalid @enderror" id="banner_title" name="banner_title" placeholder="Title" value="{{ old('banner_title', $homeBanner->banner_title) }}">
                                @error('banner_title')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('banner_button_text') is-invalid @enderror" id="banner_button_text" name="banner_button_text" placeholder="Button Text" value="{{ old('banner_button_text', $homeBanner->banner_button_text) }}">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="url" class="form-control @error('banner_button_link') is-invalid @enderror" id="banner_button_link" name="banner_button_link" placeholder="Button Link" value="{{ old('banner_button_link', $homeBanner->banner_button_link) }}">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('banner_description') is-invalid @enderror" id="banner_description" name="banner_description" rows="3">{{ old('banner_description', $homeBanner->banner_description) }}</textarea>
                    ...
                    <button type="submit" class="submit_btn">Update Home Banner</button>
