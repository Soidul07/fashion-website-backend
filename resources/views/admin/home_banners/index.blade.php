...
<div class="content-wrapper">
    <div class="content-margin">
        <div class="dashboard_heading flex-css">
            <div class="name">
                <h2 class="m-0">Home Banner Management</h2>
            </div>
                ...
                <div class="card-body">
                    <div class="border-box">
                        <div class="card-header">
                            <a href="{{ route('admin.home-banners.create') }}" class="submit_btn">Add Home Banner</a>
                        </div>
                    </div>
                    <table id="homeBannersTable" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                <th>Image</th>
                                <th>Title</th>
                        ...
                        <tbody>
                            @foreach($homeBanners as $banner)
                                <tr>
                                    <td>
                                        <div class="table_thambnail">
                                            @if($banner->banner_image)
                                                <img src="{{ asset('admin_assets/uploads/' . $banner->banner_image) }}" alt="Banner Image" class="img-thumbnail" style="width: 50px;">
                                            @else
                                    ...
                                    <td>{{ $banner->banner_button_link }}</td>
                                    <td>
                                        ...
                                        <form action="{{ route('admin.home-banners.destroy', $banner->id) }}" method="POST" style="display: inline;">
                                            @csrf
                                            @method('DELETE')
