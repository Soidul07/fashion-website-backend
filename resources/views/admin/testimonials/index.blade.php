...
<div class="content-wrapper">
    <div class="content-margin">
        <div class="dashboard_heading flex-css">
            <div class="name">
                <h2 class="m-0">Testimonials Management</h2>
            </div>
                ...
                <div class="card-body">
                    <div class="border-box">
                        <div class="card-header">
                            <a href="{{ route('admin.testimonials.create') }}" class="submit_btn">Add Testimonial</a>
                        </div>
                    </div>
                    <table id="custDataTable" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Image</th>
                                ...
                                <td>
                                    <div class="table_thambnail">
                                        @if($testimonial->image && file_exists(public_path('admin_assets/uploads/' . $testimonial->image)))
                                            <img src="{{ asset('admin_assets/uploads/' . $testimonial->image) }}" alt="Testimonial Image" class="img-thumbnail" style="width: 50px;">
                                        @else
