        ...
        <section class="dashboard_box dashboard_padding">
            <div class="border-box profile_edit">
                <form method="POST" action="{{ route('admin.users.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="col-6">
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    ...
                                    <input id="upload_image" name="profile_image" type="file" accept="image/*" class="form-control @error('profile_image') is-invalid @enderror" name="profile_image" style="display: none">
                                    @error('profile_image')
                    ...
                    <button type="submit" class="submit_btn">Add User</button>
