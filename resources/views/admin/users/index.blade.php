                                    ...
                                    <td>
                                        <div class="table_thambnail">
                                            @if($user->profile_image && file_exists(public_path('admin_assets/uploads/' . $user->profile_image)))
                                                <img src="{{ asset('admin_assets/uploads/' . $user->profile_image) }}" alt="Profile Image" class="img-thumbnail" style="width: 50px;">
                                            @else
                                                <img src="{{ asset('admin_assets/images/avatar.png') }}" alt="Default Profile Image" class="img-thumbnail" style="width: 50px;">
                                            @endif
                                        </div>
                                    </td>
                                    <td>{{ $user->name }}</td>
